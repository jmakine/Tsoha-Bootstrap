...
kuvaus varchar(400),
tarkeys varchar(10),
kayttaja_id INTEGER REFERENCES Kayttaja(id), --viiteavain Kayttaja -tauluun
luokka_id INTEGER REFERENCES Luokka(id) --viiteavain Luokka -tauluun (yliluokkaan)
...
luokka_id INTEGER REFERENCES Luokka(id) NOT NULL, --viiteavain Luokka -tauluun (yliluokkaan)
